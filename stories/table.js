...
/*
tableStory.add('Cart', () => {
  const headers = ['#', 'Image', 'Beer name', 'Quantity', '' ];
  const image = (<img src='https://www.maxpixel.net/static/photo/2x/Luck-Letters-Data-Table-Las-Vegas-Numbers-Games-2097929.jpg'/>)
  const dataSet = [
    ['1', 'System Architect', 'Edinburgh', '5', '<img src="https://www.maxpixel.net/static/photo/2x/Luck-Letters-Data-Table-Las-Vegas-Numbers-Games-2097929.jpg"/>']
  ];
